...
This chart sets up scheduled jobs to periodically executes a [Log10x pipeline](https://doc.log10x.com/concepts/pipeline) inside k8.

Use this chart to set up periodic [Compile pipeline](https://doc.log10x.com/compile) or [Log10x Cloud Reporter](https://doc.log10x.com/run/apps/cloud/reporter)

## How to deploy

Deployment instructions for Compile are found [Here](https://doc.log10x.com/deploy/compile)

Deployment instructions for Cloud Reporter are found [Here](https://doc.log10x.com/deploy/apps/cloud/reporter)
